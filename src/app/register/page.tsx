...
export default function RegisterPage() {
  ...
  const fields = [
    { name: "name", label: "Full Name", type: "text", placeholder: "Hamed Omar" },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-1 text-slate-400">Start turning ideas into structured MVP plans</p>
        </div>
        ...
        <div className="rounded-2xl border border-slate-700/50 bg-slate-900/80 backdrop-blur-xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {fields.map((field) => (
              <div key={field.name}>
                <label htmlFor={field.name} className="text-sm font-medium text-slate-300 block mb-1.5">
